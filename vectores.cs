...
DescripciC3n:    Metro Aventura
Un juego de recorrido basado en el Metro de MedellC-n, 
donde el jugador debe visitar diferentes estaciones 
en un orden especC-fico.
Uso de arreglos: Se utiliza un arreglo unidimensional 
para representar las estaciones del metro y otro para 
el orden de visita.
Conceptos reforzados: DeclaraciC3n de arreglos, acceso 
a elementos, bC:squeda en arreglos, comparaciC3n de valores.
Elementos culturales: Incorpora el sistema de Metro de 
MedellC-n y lugares emblemC!ticos de la ciudad como el 
Parque Explora, el JardC-n BotC!nico y el Parque ArvC-.
